    ...
    override fun handleTextMessage(session: WebSocketSession, message: TextMessage) {
        ...
        when (node.path("type").asText()) {
            ...
            "OBG_GAME_OVER" -> {
                ...
                broadcast(room, mapper.convertValue(node, object : com.fasterxml.jackson.core.type.TypeReference<Map<String, Any?>>() {}))
            }
            else -> broadcast(room, mapper.convertValue(node, object : com.fasterxml.jackson.core.type.TypeReference<Map<String, Any?>>() {}))
        }
    }
